...
$Icons = 'src="./admin/template/images/wmenu/';
	...
	echo "\n\t".'<img class="WM_MenuImg" ' .$Icons. 'WM_Web.svg" ';
	...
	echo "\n\t".'<img class="WM_MenuImg" ' .$Icons. 'WM_Admin.svg" ';
	...
	echo "\n\t".'<img class="WM_MenuImg" ' .$Icons. 'WM_Icons.svg" ';
	...
	echo "\n\t".'<img class="WM_MenuImg" ' .$Icons. 'WM_Settings.svg" ';
	...
	echo "\n\t".'<img class="WM_MenuImg" ' .$Icons. 'WM_Adm_Ino.svg" ';
	...
	echo "\n\t".'<img class="WM_MenuImg" ' .$Icons. 'WM_Adm_RPi.svg" ';
	...
	echo "\n\t".'<img class="WM_MenuImg" ' .$Icons. 'WM_System.svg" ';
