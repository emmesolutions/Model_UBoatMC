...
// $WM_Pstn = $_GET[WM_URI_PSTN]. '&amp;';
	...
	// Link
	$WM_WMenu_20 = "\t".'<a accesskey="2" href="index.php?'.$WM_Pstn.'&amp;'.WM_SYS_VAL_CNTANR.'=01"> ';
	$WM_WMenu_21 = "\t".'<a accesskey="2" href="index.php?'.$WM_Pstn.'&amp;'.WM_SYS_VAL_CNTANR.'=00"> ';
...
echo "\n\t".'<div class="WM_Menu">'."\n";
	...
	// Show/Hide Container
	if( $WM_SCookies[WM_SYS_VAL_CNTANR] == "00" ) { echo $WM_WMenu_20; $Icons = 'src="./system/template/images/wmcorner/Crn_icon_100.svg'; }
	if( $WM_SCookies[WM_SYS_VAL_CNTANR] == "01" ) { echo $WM_WMenu_21; $Icons = 'src="./system/template/images/wmcorner/Crn_icon_100.svg'; }
