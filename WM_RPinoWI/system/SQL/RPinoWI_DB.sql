...
CREATE TABLE IF NOT EXISTS WM_OpWI (
	id int(10) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT 'ID',
	Cl VARCHAR(2) NOT NULL DEFAULT 'A0' COMMENT 'Clums',
	R1 VARCHAR(2) NOT NULL DEFAULT '01' COMMENT 'Row01',
	R2 VARCHAR(2) NOT NULL DEFAULT '01' COMMENT 'Row02',
	R3 VARCHAR(2) NOT NULL DEFAULT '01' COMMENT 'Row03',
	R4 VARCHAR(2) NOT NULL DEFAULT '01' COMMENT 'Row04',
	R5 VARCHAR(2) NOT NULL DEFAULT '01' COMMENT 'Row05',
	R6 VARCHAR(2) NOT NULL DEFAULT '01' COMMENT 'Row06',
	R7 VARCHAR(2) NOT NULL DEFAULT '01' COMMENT 'Row07',
	R8 VARCHAR(2) NOT NULL DEFAULT '01' COMMENT 'Row08'
);
/*  Value WM_OpWI */
INSERT INTO WM_OpWI (
	id,
...
CREATE TABLE IF NOT EXISTS WM_DataLogger (
	...
	Rd1Trm VARCHAR(6) NOT NULL DEFAULT '' COMMENT 'Rd1Trm',
	Rd2Trm VARCHAR(6) NOT NULL DEFAULT '' COMMENT 'Rd2Trm',	
